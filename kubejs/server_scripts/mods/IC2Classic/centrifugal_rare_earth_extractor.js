ServerEvents.recipes(event => {
    ...
    , 'ic2:advanced_machine_block', [
         event.recipes.create.deploying(inter, [inter, 'ic2:rare_earth_extractor']) //Шаблон руки
        ,event.recipes.create.deploying(inter, [inter, 'ic2:cell_electrolyzed_water']) //Шаблон руки
        ,event.recipes.create.deploying(inter, [inter, 'ic2:cell_electrolyzed_water']) //Шаблон руки
