ServerEvents.recipes(event => {
    ...
    event.remove({output: 'ic2:electric_blast_furnace'})

    // добавление крафта ItemId
    let inter = 'minecraft:blast_furnace'
    event.recipes.create.sequenced_assembly(
        'ic2:electric_blast_furnace'
    , 'ic2:machine_block', [
//        ,event.recipes.create.pressing(inter, inter) // Шаблон пресса
         event.recipes.create.deploying(inter, [inter, 'minecraft:blast_furnace']) //Шаблон руки
...
//        ,event.recipes.create.cutting(inter, inter) // Шаблон пилы
  ...
  event.recipes.create.mechanicalCrafting('ic2:electric_blast_furnace', [
    'AAA',
    'BCB',
    'AAA'
  ], {
